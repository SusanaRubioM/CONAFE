...
#================================================================ PC010 =================================================================
    path('generar_lista_aspirantes/', views.generar_lista_aspirantes_pdf, name='generar_lista_aspirantes'),

    path('subir_resultados/', views.subir_resultados, name='subir_resultados'),
    path('subir_resultados/', views.subir_resultados, name='subir_resultados'),
