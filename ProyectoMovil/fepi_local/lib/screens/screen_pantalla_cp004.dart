...
import 'package:fepi_local/widgets/tabla_matriz_act1.dart';
              ...
              body: TabBarView(
                children: [
                  ...
                  Padding(
                    ...
                    child: Column(children: [Expanded(child: TablaMatrizAct1()),Expanded(child: ActividadesScreen(idUsuario:  prefs['id_Usuario'] ?? 0))]),
                     // Tu widget de matriz de actividades
                  ),
