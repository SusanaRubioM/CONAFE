...
class TablaMatrizAct1 extends StatefulWidget {
  const TablaMatrizAct1({Key? key}) : super(key: key);

  @override
  _TablaMatrizActState1 createState() => _TablaMatrizActState1();
}

class _TablaMatrizActState1 extends State<TablaMatrizAct1> {
                ...
                DropdownButtonFormField<String>(
                  ...
                  items: ccts
                      .map((cct) => DropdownMenuItem<String>(
                            value: cct['CCTId'].toString(),  // Usar ID
                            child: Text('${cct['CCTId']} - ${cct['CCTNombre']}'),
                          ))
                      .toList(),
                  onChanged: (value) {
                    setState(() {
                      _selectedCCTId = value;  // Asignar el ID del CCT
                    });
                  },
                  validator: (value) {
                    if (value == null) {
