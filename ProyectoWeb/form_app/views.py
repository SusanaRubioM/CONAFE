...
def form_view(request):
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            print(
                form.cleaned_data
            )  # Esto te ayudará a ver qué datos se han procesado correctamente
            ...
            habla_lengua_indigena = form.cleaned_data[
                "habla_lengua_indigena"
            ]  # Esto ya es True o False gracias al método clean_habla_lengua_indigena
            ...
            FormacionAcademica.objects.create(
                ...
                nivel_academico=form.cleaned_data[
                    "nivel_academico"
                ],  # Tomamos directamente el valor del formulario
